                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                (user?.displayName ?? profile['displayName'] ?? 'U')
                                    .toString()
                                    .substring(0, 1)
                                    .toUpperCase(),
                      ...
                      // Name and Email
                      Text(
                        user?.displayName ?? profile['displayName'] ?? 'ບໍ່ລະບຸຊື່',
                ...
                _buildInfoSection(
                  ...
                  children: [
                    _buildInfoItem(
                      ...
                      Icons.phone,
                      'ເບີໂທລະສັບ',
                      profile['phone'] ?? 'ບໍ່ໄດ້ລະບຸ',
                    ),
                    _buildInfoItem(
                      context,
                      Icons.location_on_outlined,
                      'ແຂວງ/ເມືອງ',
                      profile['province'] ?? 'ບໍ່ໄດ້ລະບຸ',
                    ),
                  ],
                ),
                
                // Skills Section
                if ((profile['skills'] as List?)?.isNotEmpty ?? false)
                  _buildInfoSection(
                    context,
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  profile['resumeUrl'] != null && profile['resumeUrl'].toString().isNotEmpty
                                      ? 'ມີໄຟລ໌ເລຊູເມແລ້ວ'
